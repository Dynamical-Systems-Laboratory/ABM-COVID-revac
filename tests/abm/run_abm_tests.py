...
# Test suite 2
ut.msg('ABM interface - construction test - collective simulation setup', CYAN)
...
# Test suite 3
ut.msg('ABM interface - infection transmission test - collective simulation setup', CYAN)
subprocess.call(['./trans_inf_test_v2'], shell=True)

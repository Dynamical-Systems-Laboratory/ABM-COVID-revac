...
max_clr = [125, 5, 31]/255;
% Number of colors to use (lowest is white)
clr_points = 21;

plot_title = 'Total deaths';
ylimits = [0,850];
clevels = [5, 20, 50, 100, 200, 400, 600];
cb_ticks = [0, 250, 450, 650, 850];
cb_tick_labels = {'0', '250', '450', '650', '850'};
...
ylimits = [0,2.5e5];
clevels = [2e3, 5e3, 1e4, 2e4, 5e4, 1e5];
cb_ticks = [0, 0.5e5, 1e5, 1.5e5, 2e5, 2.5e5];
